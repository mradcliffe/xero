...
/**
 * @file
 * Provides \Drupal\Tests\xero\Plugin\Field\FieldType\XeroReferenceTest
 */

namespace Drupal\Tests\xero\Plugin\Field\FieldType;
...
class XeroReferenceTest extends BaseFieldDefinitionTestBase {
  ...
  protected function getModuleAndPath() {
    return array('xero', dirname(dirname(dirname(dirname(dirname(__DIR__))))));
  }
